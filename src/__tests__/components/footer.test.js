...
describe('<Footer />', () => {
  it('renders the <Footer /> with populated data', () => {
    const { container, getByText } = render(
      <Footer>
      <Footer.Title>Questions? Call 020-79 06 35</Footer.Title>
      <Footer.Break />
      <Footer.Row>
        <Footer.Column>
      ...
      <Footer.Break />
      <Footer.Text>Netflix Scandinavia</Footer.Text>
    </Footer>
    );

    expect(getByText('Questions? Call 020-79 06 35')).toBeTruthy();
